...
LDFLAGS = ./MLX42/build/libmlx42.a -L$(shell brew --prefix readline)/lib -lreadline   
UNAME = $(shell uname)
NAME = MetallC64 
...
ifeq ($(UNAME), Darwin)
	...
	LDFLAGS += -lglfw -L ~/.brew/opt/glfw/lib  -I$(shell brew --prefix readline)/include -framework Cocoa -framework IOKit
endif
